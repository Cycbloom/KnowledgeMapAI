...
router.get('/quiz-sets', requireAuth, async (req: AuthRequest, res: Response) => {
...
router.delete(
  ...
  async (req: AuthRequest, res: Response) => {
    ...
    try {
      ...
      const { error } = await req.supabase!.from('quiz_sets').delete().eq('id', id);
...
router.post(
  ...
  async (req: AuthRequest, res: Response) => {
    ...
    try {
      ...
      const { error: insertError } = await req.supabase!.from('quiz_set_cards').insert({
        quiz_set_id: id,
        card_id,
        display_order: displayOrder,
      });
