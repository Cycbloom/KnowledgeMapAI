...
router.get("/templates", requireAuth, validate({ query: getTemplatesQuerySchema }), async (req, res) => {
...
router.get("/templates/categories", requireAuth, async (req, res) => {
    const supabase = req.supabase;
    if (!supabase) {
        return res
            .status(500)
...
router.get("/templates/:id", requireAuth, validate({ params: uuidParamsSchema }), async (req, res) => {
    const supabase = req.supabase;
    if (!supabase) {
        return res
            .status(500)
...
router.post("/templates", requireAuth, validate({ body: createTemplateSchema }), async (req, res) => {
    const supabase = req.supabase;
    if (!supabase) {
        return res
            .status(500)
    ...
    const { name, description, category, title_template, description_template, estimated_duration, tags, priority, is_default, } = req.body;
    const { data: template, error } = await supabase
        .from("task_templates")
        .insert({
        user_id: req.user.id,
...
router.put("/templates/:id", requireAuth, validate({ params: uuidParamsSchema, body: updateTemplateSchema }), async (req, res) => {
    const supabase = req.supabase;
    if (!supabase) {
        return res
            .status(500)
...
router.delete("/templates/:id", requireAuth, validate({ params: uuidParamsSchema }), async (req, res) => {
    const supabase = req.supabase;
    if (!supabase) {
        return res
            .status(500)
...
router.post("/templates/:id/apply", requireAuth, validate({ params: uuidParamsSchema, body: applyTemplateSchema }), async (req, res) => {
    const supabase = req.supabase;
    if (!supabase) {
        return res
            .status(500)
...
router.post("/templates/:id/duplicate", requireAuth, validate({ params: uuidParamsSchema }), async (req, res) => {
    const supabase = req.supabase;
    if (!supabase) {
        return res
            .status(500)
...
router.put("/templates/:id/set-default", requireAuth, validate({ params: uuidParamsSchema }), async (req, res) => {
    const supabase = req.supabase;
    if (!supabase) {
        return res
            .status(500)
