...
export const pricingService = {
  ...
  calculateCost(
    ...
    const cachedCost = (safeCachedTokens / 1_000_000) * pricing.cachedInputPricePer1M;
    const uncachedInputCost = (uncachedInputTokens / 1_000_000) * pricing.uncachedInputPricePer1M;
  ...
  calculateDetailedCost(
    ...
    const cachedInputCost = (safeCachedTokens / 1_000_000) * pricing.cachedInputPricePer1M;
    const uncachedInputCost = (uncachedInputTokens / 1_000_000) * pricing.uncachedInputPricePer1M;
    const outputCost = (outputTokens / 1_000_000) * pricing.outputPricePer1M;
    const totalCost = cachedInputCost + uncachedInputCost + outputCost;

    const costIfNoCache = ((inputTokens) / 1_000_000) * pricing.uncachedInputPricePer1M;
