...
The 'answer' should be the missing text. When the sentence has multiple blanks, separate the answers with commas (one answer per blank, in order). Provide a detailed 'explanation'.`,
...
- summary: 20-30字的简短概览，概括该知识点的核心内容，应比标题更具体但比完整内容更精炼
- description: 图谱的详细介绍（3-5 句、约 150-250 字），说明该领域涵盖的内容、主要分支、前置知识与实际应用价值。要写得充实丰富，不要只写一句话。
- All text (title/content/summary/description) must be written in {{outputLanguage}}.`,
