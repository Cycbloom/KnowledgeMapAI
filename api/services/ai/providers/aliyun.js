...
export class AliyunProvider extends BaseAIProvider {
    ...
    async synthesizeSpeech(text, voice = 'Cherry', speed = 1.0, format = 'mp3') {
        if (!this.hasKey) {
    ...
    async synthesizeLongText(text, voice, speed, _format) {
    ...
    async synthesizeChunk(text, voice, speed, format) {
