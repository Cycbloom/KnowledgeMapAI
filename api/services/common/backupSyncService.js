...
export async function syncExistingBackups() {
    try {
        ...
        for (const userId of userDirs) {
            ...
            for (const file of files) {
                ...
                if (existing)
                    continue;
                let type = 'manual';
                if (file.startsWith('auto_30min'))
                    type = 'auto_30min';
                else if (file.startsWith('auto_5hour'))
                    type = 'auto_5hour';
                else if (file.startsWith('auto_1day'))
                    type = 'auto_1day';
...
//# sourceMappingURL=backupSyncService.js.map