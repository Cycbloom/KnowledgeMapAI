...
export class PDFService {
    ...
    initFontPath() {
        ...
        const findFontFile = (dir) => {
            ...
            if (noto)
                return path.join(dir, noto.name);
        ...
        if (fs.existsSync(projectFontDir)) {
            ...
            if (found) {
                ...
                if (anyFont)
                    this.fontPath = path.join(projectFontDir, anyFont);
            }
        }
    ...
    generateReport(graph, nodes, edges, options, outputStream) {
    ...
    renderNodeDetails(doc, nodes, edges) {
