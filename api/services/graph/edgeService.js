...
export class EdgeService {
    async create(supabase, data) {
        const { graph_id, source_knowledge_point_id, target_knowledge_point_id, relationship_type, weight, custom_label, custom_color, custom_line_style, show_arrow } = data;
    ...
    async update(supabase, edgeId, data) {
    ...
    async getGraphEdges(supabase, graphId) {
    ...
    async deleteByKnowledgePoint(supabase, graphId, knowledgePointId) {
...
//# sourceMappingURL=edgeService.js.map