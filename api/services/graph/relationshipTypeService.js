...
export class RelationshipTypeService {
    ...
    async getByCategory(supabase, category, userId) {
        const { data, error } = await supabase
            .from('relationship_types')
            .select('*')
    ...
    async create(supabase, userId, data) {
    ...
    async update(supabase, id, userId, data) {
