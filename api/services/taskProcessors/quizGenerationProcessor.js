...
export class QuizGenerationProcessor {
    async process(taskId, userId, payload, supabase, updateTaskStatus) {
        ...
        `)
            ...
            if (edges) {
                edges.forEach((e) => parentMap.set(e.target_knowledge_point_id, e.source_knowledge_point_id));
            }
          ...
          `)
            ...
            if (allGeneratedCards.length > 0) {
                const quizSetCardsToInsert = allGeneratedCards.map((card, index) => ({
...
//# sourceMappingURL=quizGenerationProcessor.js.map