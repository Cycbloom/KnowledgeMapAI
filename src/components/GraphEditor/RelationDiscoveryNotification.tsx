...
import {
  ...
  type RelationDiscoveryNotice,
} from '../../store/useRelationDiscoveryNotificationStore';
...
export const RelationDiscoveryNotificationBridge: React.FC<{
  onClose: () => void;
  onContinue: () => void;
}> = ({ onClose, onContinue }) => {
  ...
  useEffect(() => {
    if (notice) {
      ...
      useNotificationManager.getState().dismiss('relation-discovery');
    }
  }, [notice, onClose, onContinue]);
