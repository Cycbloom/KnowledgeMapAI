          ...
          <div className="flex gap-3">
            <div className="relative flex-1">
              ...
              <input
                ...
                placeholder="搜索模板..."
                className="w-full pl-10 pr-4 py-2.5 rounded-xl bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-600 text-slate-900 dark:text-white placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-primary-500/50"
              />
            </div>
            {onCreateNew && (
              <button
                onClick={onCreateNew}
                className="flex items-center gap-2 px-4 py-2.5 rounded-xl bg-gradient-to-r from-primary-500 to-primary-500 text-white font-medium hover:from-primary-400 hover:to-primary-400 transition-all"
              >
                <Plus size={18} />
                新建模板
              </button>
              ...
              <div className="p-4">
                  ...
                  {extractPlaceholders(selectedTemplate).map(key => (
                    <div key={key}>
                      ...
                      <input
                        ...
                        placeholder={`输入${key}...`}
                        className="w-full px-3 py-2 rounded-lg bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-600 text-slate-900 dark:text-white text-sm focus:outline-none focus:ring-2 focus:ring-primary-500/50"
                      />
                    </div>
                  ))}
                </div>
                <div className="flex justify-end gap-2 mt-4">
                  ...
                  <button
                    ...
                    className="px-4 py-2 rounded-lg bg-gradient-to-r from-primary-500 to-primary-500 text-white font-medium hover:from-primary-400 hover:to-primary-400 transition-all"
                  >
                    应用模板
                  </button>
                </div>
