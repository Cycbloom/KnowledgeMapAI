...
export const learningPathsApi = {
  ...
  addNode: (pathId: string, data: AddNodeInput) =>
    request(`/learning-paths/${pathId}/nodes`, {
      method: "POST",
      body: JSON.stringify(data),
    }),

  updateNodeStatus: (pathId: string, nodeId: string, status: NodeStatus) =>
    request(`/learning-paths/${pathId}/nodes/${nodeId}/status`, {
      method: "PUT",
      body: JSON.stringify({ status }),
    }),

  reorderNodes: (pathId: string, nodeIds: string[]) =>
    request(`/learning-paths/${pathId}/nodes/reorder`, {
      method: "PUT",
  ...
  getProgress: (pathId: string) =>
    request(`/learning-paths/${pathId}/progress`),
  ...
  createPlan: (pathId: string, data: CreatePlanInput) =>
    request(`/learning-paths/${pathId}/plans`, {
      method: "POST",
      body: JSON.stringify(data),
    }),
  ...
  generateFromGraph: (data: GeneratePathInput) =>
    request("/learning-paths/generate", {
      method: "POST",
      body: JSON.stringify(data),
    }),
  ...
  adjust: (
    ...
    request(`/learning-paths/${id}/adjust`, {
      method: "POST",
      body: JSON.stringify(data),
    }),
