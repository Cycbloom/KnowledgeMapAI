/**
 * @deprecated 此模块已被 src/utils/offlineMutations.ts 的 offlineMutationQueue 替代。
 * 保留仅为向后兼容，新代码应使用 offlineMutationQueue。
 * 将在下一个主要版本中移除。
 */
...
import { offlineMutationQueue } from './offlineMutations';
